...
#     # Relationships
#     ride = relationship("DbRide", back_populates="reviews")  # Each review is linked to a ride
#     user = relationship("DbUser", foreign_keys=[user_id], back_populates="reviews_received")  # The user who received the review
#     reviewer = relationship("DbUser", foreign_keys=[reviewer_id], back_populates="reviews_written")  # The user who wrote the review
...
# class DbReview(Base):
#     """Represents a review given by one user to another about a ride."""
#     __tablename__ = "reviews"

#     id = Column(Integer, primary_key=True, index=True)
#     ride_id = Column(Integer, ForeignKey("rides.id"), nullable=False)
#     reviewer_id = Column(Integer, ForeignKey("users.id"), nullable=False)  # User who wrote the review
#     reviewee_id = Column(Integer, ForeignKey("users.id"), nullable=False)  # User who received the review
#     rating = Column(Float, nullable=False)
#     comment = Column(String, nullable=True)
#     review_time = Column(DateTime, default=func.now(), nullable=False)
