...
# from db.enums import PaymentStatus, PaymentMethod, BookingStatus, UserRole  # ✅ Yeni `enums.py` dosyasından import et
...
#     payment_status = Column(SQLEnum(PaymentStatus), default=PaymentStatus.PENDING, nullable=False)  # ✅ Enum olarak düzeltildi
#     payment_method = Column(SQLEnum(PaymentMethod), nullable=False)  # ✅ Yeni ekleme (Dropdown için)
#     charge_id = Column(String, nullable=True)  # ✅ Kredi kartı ödemeleri için ekleme
...
from db.database import Base
from db.enums import PaymentStatus, PaymentMethod, BookingStatus, UserRole, ReviewCategory, ReviewVoteType, ComplaintStatus
