...
# # ✅ Yeni bir ödeme kaydı oluştur
# def create_payment(db: Session, user_id: int, ride_id: int, amount: float, status: str, payment_method: str, charge_id: str = None):
#     """
...
#         charge_id=charge_id  # Sadece kredi kartı ödemeleri için
#     )
#     db.add(new_payment)
#     db.commit()
#     db.refresh(new_payment)
...
#             return None  # Eğer charge_id yoksa geri ödeme yapılamaz
#         try:
...
#             return None  # Stripe iade işlemi başarısız oldu

#     # ✅ iDEAL veya PayPal üzerinden ödeme yapıldıysa, manuel olarak işaretle
#     elif payment.payment_method in ["ideal", "paypal"]:
#         payment.payment_status = "refund_pending"  # İdeal ve PayPal iadesi manuel olarak işlenir
#         db.commit()
#         db.refresh(payment)
#         return payment
